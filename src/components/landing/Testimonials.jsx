...
const testimonials = [
  {
    ...
    quote:
      "FixlyHandy unified our vendors and crews in one dashboard. Dispatching is now effortless.",
  },
  {
    name: "Priya Sharma",
    ...
    <section id="about" className="bg-white">
      <div className="mx-auto w-full max-w-none px-6 md:px-10 lg:px-14 xl:px-16 2xl:px-20 py-16">
        <div className="text-center">
          ...
          <p className="mt-3 text-slate-600">Enterprise teams scale confidently with FixlyHandy.</p>
        </div>
