 ...
 * Chatbot.jsx
 *
 * The root floating chatbot widget for the Fixlyhandy landing page.
 *
  ...
  useEffect(() => {
    ...
    const handler = (e) => {
      if (windowRef.current && !windowRef.current.contains(e.target)) {
        ...
        const launcher = document.getElementById('fixlyhandy-chat-launcher-btn');
    ...
    <>
      ...
      {(isOpen || hasOpened) && (
        <div
          ...
          role="dialog"
          aria-label="FixlyHandy Chat Assistant"
          aria-modal="true"
        >
      ...
      {/* ── Launcher Button ───────────────────────────────────────────────── */}
      <div className="trakjobs-chat-launcher" aria-label="Open chat" id="fixlyhandy-chat-launcher-btn">
        <button
