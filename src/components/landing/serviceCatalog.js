...
const serviceCatalog = [
  ...
  },
  {
    ...
    services: [
      { name: "Leak Detection & Repair", basePrice: 89, duration: "1-2 hrs" },
      { name: "Drain Cleaning & Unclogging", basePrice: 99, duration: "1-2 hrs" },
      { name: "Water Heater Installation & Repair", basePrice: 149, duration: "2-3 hrs" },
      { name: "Faucet & Fixture Installation", basePrice: 79, duration: "1 hr" },
      { name: "Toilet Repair & Installation", basePrice: 95, duration: "1-2 hrs" },
      { name: "Pipe Repair & Replacement", basePrice: 119, duration: "2-3 hrs" },
      { name: "Garbage Disposal Installation", basePrice: 85, duration: "1 hr" },
      { name: "Sump Pump Installation", basePrice: 139, duration: "2 hrs" },
      { name: "Gas Line Installation", basePrice: 159, duration: "2-3 hrs" },
      { name: "Water Filtration Systems", basePrice: 129, duration: "2 hrs" },
      { name: "Emergency Plumbing (24/7)", basePrice: 179, duration: "1 hr" },
    ],
  },
  {
