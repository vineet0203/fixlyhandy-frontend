 ...
 *
 * The rule-based conversation engine for FixlyHandy chatbot.
 */
...
const SUPPORT_ITEMS = [
  {
    label: 'Call Us',
    sub: '+1 (800) FIXLYHANDY',
    href: 'tel:+18003495942',
    icon: '📞',
    bgColor: '#dbeafe',
    external: false,
  },
  ...
  },
  {
    ...
    href: 'mailto:support@fixlyhandy.com?subject=Callback Request',
    icon: '🔔',
    bgColor: '#fce7f3',
    external: false,
  },
