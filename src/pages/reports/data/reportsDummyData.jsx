...
// Static config — never changes, no API needed
...
/**
 * Provider component that fetches all report data once
...
export const ReportsDataProvider = ({ children }) => {
  ...
  return (
    <ReportsDataContext.Provider value={{ data, loading, error, refetch: fetchData }}>
      {children}
...
/**
 * Hook to consume reports data in any child component.
 */
...
// ──────────────────────────────────────
//  Convenience hooks per data section
// ──────────────────────────────────────
